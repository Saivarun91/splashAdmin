...
export default function VisionMissionPage() {
  ...
  const save = async () => {
    try {
      ...
      await homepageAPI.updatePageContent('vision_mission', parsed);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Vision & Mission Page</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-2">Edit vision and mission content (JSON).</p>
      </div>
      {message.text && (
